...
function navbarSlideLine() {
  ...
  e[0] &&
    a.css({
      width: e.width() + 16,
      left:
        e.parent().position().left + (e.parent().width() - e.width()) / 2 - 8,
    });
}
$(window).on("load", function () {
  setTimeout(function () {
    ...
    $(".navbar .dropdown").on("mouseout", function () {
      $(this).find(".dropdown-menu").hasClass("show") &&
        $(".dropdown-toggle", this).dropdown("toggle");
    }),
    $(".navbar .dropdown-toggle").on("click", function () {
      if ($(this).hasClass("show")) return !1;
    }),
    // 0 < $(".page-animated").length && InitWaypointAnimations(),
    setTimeout(function () {
  ...
  (function (n, a, e) {
    ...
    var o,
      i,
      s = e("body");
    e(s).scrollspy({ target: "#navigation" }),
      navbarSlideLine(),
      e(n).on("activate.bs.scrollspy", function (n) {
        navbarSlideLine();
      }),
      e(n).scroll(function () {
        50 <= e(n).scrollTop()
          ? 992 < e(n).width() &&
            (e(".navbar").addClass("navbar-fixed navbar-shadow"),
            e(".navbar #slide-line").removeClass("d-none"),
            inverseNavbar(!0))
          : (e(".navbar").removeClass("navbar-fixed navbar-shadow"),
            e(".navbar #slide-line").addClass("d-none"),
            inverseNavbar(!1));
      }),
      navbarAbsolute(),
      e(n).resize(function () {
    ...
    //     e("#video").attr(
    //       "src",
    //       i + "?rel=0&amp;showinfo=0&amp;modestbranding=1&amp;autoplay=1"
    //     );
    //   }),
